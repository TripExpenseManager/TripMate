...
public class AddExpenseNew extends AppCompatActivity {
    ...
    DataBaseHelper dataBaseHelper = new DataBaseHelper(AddExpenseNew.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        defaultCurrency = new CurrencyModel(Utils.getCorrespondingCurrencyName(dataBaseHelper.getTripData(trip_id).getTripcurrency()),dataBaseHelper.getTripData(trip_id).getTripcurrency());
        selectedCurrency = defaultCurrency;


        for (String s : personsList){
            expByPersonsMultipleList.add(0.0);
            esbEquallyCheckedList.add(true);
        ...
        categorySelected = categoriesList.get(0);
        ...
        etAmountSpent.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    totalAmountSpent = Double.parseDouble(s.toString());
                }catch (Exception e){
        ...
        etConversionRate.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    conversionRate = Double.parseDouble(s.toString());
                }catch (Exception e){
                    conversionRate = 0.0;
                }
    ...
    void openExpendByDialog(){
        LayoutInflater li = LayoutInflater.from(AddExpenseNew.this);
        View promptsView = li.inflate(R.layout.expense_paid_by_dialog, null);
        final AlertDialog.Builder alertDialogBuilderExpPaidBy = new AlertDialog.Builder(AddExpenseNew.this);
        ...
        rvExpPaidBySingle.setLayoutManager(new LinearLayoutManager(AddExpenseNew.this));

        expByMultipleAdapter = new ExpByMultipleAdapter(personsList);
        rvExpPaidByMultiple.setAdapter(expByMultipleAdapter);
        rvExpPaidByMultiple.setLayoutManager(new LinearLayoutManager(AddExpenseNew.this));
            ...
            public void onClick(View v) {
                if(expPaidByFlag == 1) {
                    ...
                    if((sum-totalAmountSpent == 0)){
                        ...
                        AlertDialog.Builder alertDialogExpByError = new AlertDialog.Builder(AddExpenseNew.this);
    ...
    void openCurrenciesDialog(){
        ...
        AlertDialog.Builder alertDialogBuilderCurrencies = new AlertDialog.Builder(AddExpenseNew.this);
        ...
        rvCurrencies.setLayoutManager(new LinearLayoutManager(AddExpenseNew.this));
        ...
        currencySearchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                InputMethodManager imm = (InputMethodManager) AddExpenseNew.this.getSystemService(Context.INPUT_METHOD_SERVICE);
...
*/
    ...
    void openCategoriesDialog(){
        ...
        AlertDialog.Builder alertDialogBuilderCategories = new AlertDialog.Builder(AddExpenseNew.this);
    ...
    void setDate(){
        ...
        llDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddExpenseNew.this,dateSetListener,mYear,mMonth,mDay);
    ...
    void addExpenseToTheDatabase(){
        ...
        if(descriptionEntered.equalsIgnoreCase("")){
        ...
        else if(expTypeFlag == 1 && deposit_amount_remaining < getTotalAmountSpentForDepositMoneyChecking()){
            Snackbar.make(findViewById(android.R.id.content), "You do not have sufficient deposit money. Deposit money remaining = "+deposit_amount_remaining +" "+defaultCurrency.getCurrencyCode(), Snackbar.LENGTH_LONG).show();
        }
        else{
            ...
            dataBaseHelper.addExpenseNew(modelToBeAdded);
